...
const GeoLayout mario_002_switch_opt0_001_switch_opt1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_mesh_layer_5),
...
const GeoLayout mario_002_switch_opt0_001_switch_opt2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_TRANSPARENT, mario_000_offset_mesh_layer_5_mat_override_metal_v4_001_0),
